  ...
  LESS_THAN_FIVE: [
    {
      ...
      percentageOfLessons: 0.5,
    },
  ],
  LESS_THAN_TEN: [
    {
      expectedRate: SUCCESS_RATES.TIER_1,
      percentageOfLessons: 0.6,
    },
    {
      expectedRate: SUCCESS_RATES.TIER_3,
      percentageOfLessons: 0.2,
    },
  ],
  LESS_THAN_FIFTEEN: [
    {
      expectedRate: SUCCESS_RATES.TIER_2,
      percentageOfLessons: 0.8,
    },
    {
      expectedRate: SUCCESS_RATES.TIER_3,
      percentageOfLessons: 0.4,
    },
  ],
  LESS_THAN_TWENTY: [
    {
