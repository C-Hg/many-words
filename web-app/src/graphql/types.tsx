...
export type GetNextExerciseQuery = {
  exercise: Pick<Exercise, "id" | "type"> & {
    words: Array<
      Maybe<
        Pick<
          ExerciseWord,
...
export type SetLanguageMutation = {
  setLanguage: Pick<SetLanguageMutationResponse, "success"> & {
 ...
 * });
 */
export function useGetNextExerciseQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetNextExerciseQuery,
    GetNextExerciseQueryVariables
  >
) {
  return Apollo.useQuery<GetNextExerciseQuery, GetNextExerciseQueryVariables>(
    GetNextExerciseDocument,
    baseOptions
  );
}
export function useGetNextExerciseLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetNextExerciseQuery,
    GetNextExerciseQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetNextExerciseQuery,
    GetNextExerciseQueryVariables
  >(GetNextExerciseDocument, baseOptions);
}
export type GetNextExerciseQueryHookResult = ReturnType<
  typeof useGetNextExerciseQuery
>;
export type GetNextExerciseLazyQueryHookResult = ReturnType<
  typeof useGetNextExerciseLazyQuery
>;
...
`;
export type SetLanguageMutationFn = Apollo.MutationFunction<
  SetLanguageMutation,
...
export function useSetLanguageMutation(
  ...
  return Apollo.useMutation<SetLanguageMutation, SetLanguageMutationVariables>(
    SetLanguageDocument,
    baseOptions
  );
}
...
>;
export type SetLanguageMutationResult = Apollo.MutationResult<
  SetLanguageMutation
>;
export type SetLanguageMutationOptions = Apollo.BaseMutationOptions<
  SetLanguageMutation,
  SetLanguageMutationVariables
>;
